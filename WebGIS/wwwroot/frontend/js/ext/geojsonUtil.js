define(["dojo/_base/declare"], function (declare) {
    return declare(null, {
        ...
        geojsonToArcGIS: function (geojson, spatialReference, idAttribute) {
            ...
            switch (geojson.type) {
                ...
                case 'Feature':
                    if (geojson.geometry) {
                        result.geometry = this.geojsonToArcGIS(geojson.geometry, spatialReference, idAttribute);
                    }
                ...
                case 'FeatureCollection':
                    ...
                    for (i = 0; i < geojson.features.length; i++) {
                        result.push(this.geojsonToArcGIS(geojson.features[i], spatialReference, idAttribute));
                    }
                    break;
                case 'GeometryCollection':
                    result = [];
                    for (i = 0; i < geojson.geometries.length; i++) {
                        result.push(this.geojsonToArcGIS(geojson.geometries[i], spatialReference, idAttribute));
                    }
                    break;
            }
